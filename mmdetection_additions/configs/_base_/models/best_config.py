...
param_scheduler = [
    dict(
        begin=0, by_epoch=False, end=0.5, start_factor=0.001, type='LinearLR'),
    dict(
        begin=0,
        by_epoch=True,
        end=1,
...
test_dataloader = dict(
    ...
    dataset=dict(
        ann_file=
        '/data/patches/500_500_overlap_05_minviz_025/annotations/dataset_test_patches.json',
        data_prefix=dict(
            img=
            '/data/patches/500_500_overlap_05_minviz_025/images/'
        ),
        data_root=
        '/data/patches/500_500_overlap_05_minviz_025/',
        metainfo=dict(
            classes=[
                'cup_coral',
                'stylasterids',
...
test_evaluator = dict(
    ...
    metric='bbox',
    outfile_prefix=
    'work_dirs/500_500_overlap_05_minviz_025_spatial_deformable-detr_pretrained/test/500_500_overlap_05_minviz_025_spatial_deformable-detr_pretrained_patches',
    type='CocoMetric')
test_pipeline = [
    dict(type='LoadImageFromFile'),
    dict(type='LoadAnnotations', with_bbox=True),
...
train_dataloader = dict(
    ...
    dataset=dict(
        ann_file=
        '/data/patches/500_500_overlap_05_minviz_025/annotations/dataset_train_patches.json',
        backend_args=None,
        data_prefix=dict(
            img=
            '/data/patches/500_500_overlap_05_minviz_025/images/'
...
val_dataloader = dict(
    ...
    dataset=dict(
        ann_file=
        '/data/patches/500_500_overlap_05_minviz_025/annotations/dataset_val_patches.json',
        backend_args=None,
        data_prefix=dict(
            img=
            '/data/patches/500_500_overlap_05_minviz_025/images/'
